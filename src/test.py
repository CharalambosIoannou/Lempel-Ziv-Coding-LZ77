...
window_size=5000
path="dog1.jpg"
with open(path+'_decompress_const_window.txt','w') as f:
...
sep = ""
with open('img_test_decomp_const_window.csv', 'w') as csv:
...
path="dog1.jpg"
with open(path+'_decompress_const_buffer.txt','w') as f:
...
sep = ""
with open('img_test_decomp_const_buffer.csv', 'w') as csv:
    for row in time_array:
        csv.write(sep.join(str(row)))
        csv.write("\n")
